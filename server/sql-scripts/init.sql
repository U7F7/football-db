...
-- Vancouver Vipers
	...
	-- Surrey Titans
	INSERT INTO Athlete VALUES (34, 'Adam Desmond', '1997-11-13', 178, 65, 6045578896, 'adam.desmond@soccer.com', '778 Philosophy Lane, Vancouver', '2015-07-17', 1, 'Surrey Titans', 178000)
	INSERT INTO Athlete VALUES (35, 'Brittany Peterson', '1981-01-27', 137, 59, 7786129993, 'brittany.peterson@soccer.com', '560 Canuck St, Vancouver', '2004-11-08', 2, 'Surrey Titans', 200000)
	INSERT INTO Athlete VALUES (36, 'Ryan Son', '1999-03-10', 231, 84, 6046678901, 'ryan.son@soccer.com', '329 Jensen Way, Vancouver', '2018-06-25', 3, 'Surrey Titans', 678000)
	INSERT INTO Athlete VALUES (37, 'Georgia Cheng', '1984-07-21', 180, 59, 778019812, 'georgia.cheng@soccer.com', '008 Armour Dr, Vancouver', '2007-03-03', 4, 'Surrey Titans', 192000)
	INSERT INTO Athlete VALUES (38, 'Jared Sinew', '1991-04-03', 196, 139, 6040580095, 'jared.sinew@soccer.com', '776 Corpus Lane, Vancouver', '2012-08-14', 5, 'Surrey Titans', 70800)
	INSERT INTO Athlete VALUES (39, 'Ashley Shu', '1996-09-17', 168, 54, 7783220119, 'ashley.shu@soccer.com', '887 Compass Rd, Vancouver', '2002-05-20', 6, 'Surrey Titans', 1000000)
	INSERT INTO Athlete VALUES (40, 'Lucas Man', '1989-12-30', 203, 38, 6048571002, 'lucas.man@soccer.com', '812 Lead Dr, Vancouver', '2016-04-09', 7, 'Surrey Titans', 240000)
	INSERT INTO Athlete VALUES (41, 'Sherry Van', '1993-05-15', 188, 50, 7780091435, 'sherry.van@soccer.com', '441 Floor Rd, Vancouver', '2008-01-12', 8, 'Surrey Titans', 700000)
	INSERT INTO Athlete VALUES (42, 'Vincent Lu', '1980-07-29', 178, 43, 6044478990, 'vincent.lu@soccer.com', '128 Douglas Dr, Vancouver', '2011-09-27', 9, 'Surrey Titans', 860000)
	INSERT INTO Athlete VALUES (43, 'Mary Jane', '1987-02-27', 180, 49, 7787563299, 'mary.jane@soccer.com', '888 Thunder Rd, Vancouver', '2005-06-22', 10, 'Surrey Titans', 978000)
	INSERT INTO Athlete VALUES (44, 'Jason Billy', '1993-09-20', 180, 57, 6049890071, 'jason.billy@soccer.com', '449 Apple St, Vancouver', '2017-01-05', 11, 'Surrey Titans', 170000)
	-- Coquitlam Sharks
	INSERT INTO Athlete VALUES (45, 'Harry Ford', '1985-11-18', 188, 71, 7786543090, 'harry.ford@soccer.com', '192 Falcon Dr, Vancouver', '2003-12-14', 1, 'Coquitlam Sharks', 16700000)
	INSERT INTO Athlete VALUES (46, 'Ruth North', '1991-07-12', 137, 149, 6045589012, 'ruth,north@soccer.com', '514 Fox Way, Vancouver', '2014-07-30', 2, 'Coquitlam Sharks', 40000)
	INSERT INTO Athlete VALUES (47, 'Luke Sky', '1988-03-25', 203, 241, 7786543998, 'luke.sky@soccer.com', '123 Force Lane, Vancouver', '2009-05-01', 3, 'Coquitlam Sharks', 990000)
	INSERT INTO Athlete VALUES (48, 'Noon Locomotion', '1996-05-18', 137, 68, 7780091002, 'noon.locomotion@soccer.com', '443 Train Rd, Vancouver', '2006-10-20', 4, 'Coquitlam Sharks', 54600)
	INSERT INTO Athlete VALUES (49, 'Parker Jones', '1982-07-26', 178, 190, 6041123009, 'parker.jones@soccer.com', '652 Stone Lane, Vancouver', '2011-01-10', 5, 'Coquitlam Sharks', 981000)
	INSERT INTO Athlete VALUES (50, 'Jamie Flame', '1998-11-27', 180, 167, 7784439012, 'jamie.flame@soccer.com', '332 Yang St, Vancouver', '2001-02-15', 6, 'Coquitlam Sharks', 728000)
	INSERT INTO Athlete VALUES (51, 'Dennis Honda', '1981-01-09', 195, 136, 6045589900, 'dennis.honda@soccer.com', '126 Arch Way, Vancouver', '2015-08-17', 7, 'Coquitlam Sharks', 971000)
	INSERT INTO Athlete VALUES (52, 'Karina Allen', '1994-07-27', 178, 94, 7786519822, 'karina.allen@soccer.com', '349 Synchronization Lane, Vancouver', '2004-12-08', 8, 'Coquitlam Sharks', 144000)
	INSERT INTO Athlete VALUES (53, 'John Under', '1989-09-15', 146, 119, 6045567124, 'john.under@soccer.com', '448 Dream Rd, Vancouver', '2018-07-25', 9, 'Coquitlam Sharks', 322900)
	INSERT INTO Athlete VALUES (54, 'Alicia Yoo', '1995-11-18', 168, 120, 7781129945, 'alicia.yoo@soccer.com', '229 Ocean Rd, Vancouver', '2007-04-03', 10, 'Coquitlam Sharks', 890000)
	INSERT INTO Athlete VALUES (55, 'Cameron Jonas', '1984-03-30', 185, 146, 7781009020, 'cameron.jones@soccer.com', '776 Sting St, Vancouver', '2012-09-14', 11, 'Coquitlam Sharks', 750000)
	-- Langley Bears
	INSERT INTO Athlete VALUES (56, 'James Fort', '1990-07-17', 210, 156, 6049125567, 'james.fort@soccer.com', '554 Knob Rd, Vancouver', '2002-06-20', 1, 'Langley Bears', 150000)
	INSERT INTO Athlete VALUES (57, 'Ivana Lee', '1986-09-02', 137, 144, 7786990001, 'ivana.lee@soccer.com', '447 Jelly Way, Vancouver', '2016-05-09', 2, 'Langley Bears', 800000)
	INSERT INTO Athlete VALUES (58, 'Jim Gear', '1992-02-04', 180, 239, 6045578990, 'jim.gear@soccer.com', '761 Willow Drive, Vancouver', '2008-02-12', 3, 'Langley Bears', 60000)
	INSERT INTO Athlete VALUES (59, 'Sophia Turn', '1983-08-23', 163, 129, 77866548888, 'sophia.turn@soccer.com', '551 Sunflower Way, Vancouver', '2011-10-27', 4, 'Langley Bears', 765000)
	INSERT INTO Athlete VALUES (60, 'Andrew Lim', '1997-01-19', 196, 178, 6049980073, 'andrew.lim@soccer.com', '060 Focus St, Vancouver', '2005-07-22', 5, 'Langley Bears', 236000)
	INSERT INTO Athlete VALUES (61, 'Evelyn Crow', '1980-12-03', 137, 144, 7786527778, 'evelyn.crow@soccer.com', '445 Gold Lane, Vancouver', '2017-02-05', 6, 'Langley Bears', 743000)
	INSERT INTO Athlete VALUES (62, 'Tim Shore', '1986-04-15', 203, 345, 6045590087, 'tim.shore@soccer.com', '112 Plane Rd, Vancouver', '2004-01-14', 7, 'Langley Bears', 76500)
	INSERT INTO Athlete VALUES (63, 'Rebecca Salvador', '1992-09-30', 157, 100, 6048891112, 'rebecca.salvador@soccer.com', '887 Leaf Way, Vancouver', '2015-07-30', 8, 'Langley Bears', 106700)
	INSERT INTO Athlete VALUES (64, 'Jean Fargo', '1988-11-07', 168, 178,7782234778, 'jean.fargo@soccer.com', '119 Boar Dr, Vancouver', '2010-05-01', 9, 'Langley Bears', 178000)
	INSERT INTO Athlete VALUES (65, 'Selena An', '1995-07-12', 144, 110, 6045009122, 'selena.an@soccer.com', '132 Stores Way, Vancouver', '2006-11-20', 10, 'Langley Bears', 1780000)
	INSERT INTO Athlete VALUES (66, 'Ahmed Tom', '1982-03-06', 188, 143, 7786223489, 'ahmed.tom@soccer.com', '443 Manager St. Vancouver', '2011-02-10', 11, 'Langley Bears', 166500)
SELECT * FROM dual;
